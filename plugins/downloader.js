...
smd({
  ...
  'category': "downloader",
  'filename': __filename,
  'use': "<Hii,this is Gifted>"
}, async (_0x55aba2, _0x56da6b) => {
  try {
    let _0x204f81 = _0x55aba2.reply_text ? _0x55aba2.reply_text : _0x56da6b;
    if (!_0x204f81) {
      return _0x55aba2.reply("*_Example : .tts Hi,I am Panther-Md whatsapp bot._*");
    }
    try {
...
smd({
  ...
  try {
    ...
    let _0x4737bb = {
      'audio': _0x2ba501,
      'fileName': "Panther-Md tiktok Sound" + _0x19c223 + '.m4a',
      'mimetype': 'audio/mpeg',
      'ptt': true,
...
smd({
  ...
  try {
    ...
    try {
      ...
      let _0x4b47c3 = "./temp/Panther-Md " + _0x1d542b[0x1] + '.mp3';
    ...
    let _0x300d1a = {
      ...
      'mimetype': "audio/mpeg",
      'fileName': "Panther-Md--" + _0x1d542b[0x1] + '.mp3',
      'caption': Config.caption,
...
cmd({
  ...
  if (_0xb75e78.quoted && _0xb75e78.text) {
    ...
    if (_0x5b8ee5[0x0].includes("Panther-ᴍᴅ • sᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ")) {
      ...
      if (_0x5b8ee5[0x0].includes("Panther-ᴍᴅ • ʏᴏᴜᴛᴜʙᴇ ᴅᴏᴡɴʟᴏᴀᴅ")) {
        ...
        if (_0x5b8ee5[0x0].includes("Panther-ᴍᴅ • ᴀᴘᴋ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪsᴛ")) {
